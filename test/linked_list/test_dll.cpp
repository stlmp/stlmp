...
TEST(doubly_linked_list, all_tests){
		// simple creation etc.
	cout << "----------------------------------------------------" << endl;
	cout << "Simple list creation:" << endl;
	cout << "----------------------------------------------------" << endl;
	dll_node<int> *head0 = create_node(1);
	...
	cout << "----------------------------------------------------" << endl;
	int foo[] = {1, 2, 3, 4, 5};
	dll_node<int> *head = create_list_from_array(sizeof(foo)/sizeof(foo[0]), foo);
	...
	cout << "----------------------------------------------------" << endl;
	int foo1[] = {1, 2, 3, 4, 5};
	dll_node<int> *head1 = create_list_from_array(sizeof(foo1)/sizeof(foo1[0]), foo1);
	push(&head1, 6);
	...
	cout << "----------------------------------------------------" << endl;
	int foo2[] = {1, 2, 3, 4, 5};
	dll_node<int> *head2 = create_list_from_array(sizeof(foo2)/sizeof(foo2[0]), foo2);
	...
	cout << "----------------------------------------------------" << endl;
	int foo3[] = {1, 2, 3, 4, 5};
	dll_node<int> *head3 = create_list_from_array(sizeof(foo3)/sizeof(foo3[0]), foo3);
	append(&head3, 6);
	...
	cout << "----------------------------------------------------" << endl;
	int foo4[] = {};
	dll_node<int> *head4 = create_list_from_array(sizeof(foo4)/sizeof(foo4[0]), foo4);
	append(&head4, 6);
	...
	cout << "normal" << endl;
	int foo5[] = {1, 2, 3};
	dll_node<int> *head5 = create_list_from_array(sizeof(foo5)/sizeof(foo5[0]), foo5);
	...
	int foo52[] = {};
	dll_node<int> *head52 = create_list_from_array(sizeof(foo52)/sizeof(foo52[0]), foo52);
	delete_node_with_data(&head52, 2);
	ASSERT_EQ(get_length(head52), 0) << "delete_node_with_data doesn't seem to work as expected!";

	cout << "normal" << endl;
	int foo53[] = {1, 2, 3};
	dll_node<int> *head53 = create_list_from_array(sizeof(foo53)/sizeof(foo53[0]), foo53);
	...
	cout << "----------------------------------------------------" << endl;
	int foo6[] = {1, 2, 3};
	dll_node<int> *head6 = create_list_from_array(sizeof(foo6)/sizeof(foo6[0]), foo6);
	...
	dll_node<int> *head7 = create_list_from_array(sizeof(foo7)/sizeof(foo7[0]), foo7);
	reverse_list(&head7);
	...
	dll_node<int> *head81 = create_list_from_array(sizeof(foo8)/sizeof(foo8[0]), foo8);
	dll_node<int> *head82 = create_list_from_array(sizeof(foo8)/sizeof(foo8[0]), foo8);
