...
TEST(doubly_linked_list, basic_creation){
	dll_node<int> *head = create_node(1);
...
TEST(doubly_linked_list, create_list_from_array){
	int foo[] = {1, 2, 3, 4, 5};
...
TEST(doubly_linked_list, insert_after){
	int foo[] = {1, 2, 3, 4, 5};
	dll_node<int> *head = create_list_from_array(sizeof(foo)/sizeof(foo[0]), foo);
	insert_after(head, 6);
	ASSERT_EQ(get_length(head), 1 + sizeof(foo)/sizeof(foo[0])) << "reverse_list doesn't seem to work as expected!";
...
TEST(doubly_linked_list, append){
	int foo[] = {1, 2, 3, 4, 5};
	dll_node<int> *head = create_list_from_array(sizeof(foo)/sizeof(foo[0]), foo);
	append(&head, 6);
	ASSERT_EQ(get_length(head), 1 + sizeof(foo)/sizeof(foo[0])) << "reverse_list doesn't seem to work as expected!";
...
TEST(doubly_linked_list, append_to_null){
	int foo[] = {};
	dll_node<int> *head = create_list_from_array(sizeof(foo)/sizeof(foo[0]), foo);
	append(&head, 6);
	ASSERT_EQ(get_length(head), 1 + sizeof(foo)/sizeof(foo[0])) << "reverse_list doesn't seem to work as expected!";
...
TEST(doubly_linked_list, delete_node_with_data){
	// normal
	int foo[] = {1, 2, 3};
	dll_node<int> *head = create_list_from_array(sizeof(foo)/sizeof(foo[0]), foo);
...
TEST(doubly_linked_list, search_key){
	int foo[] = {1, 2, 3};
	dll_node<int> *head = create_list_from_array(sizeof(foo)/sizeof(foo[0]), foo);
...
TEST(doubly_linked_list, reverse_list){
...
TEST(doubly_linked_list, compare_lists){
	int foo[] = {1, 2, 3, 4, 5, 6, 7, 8, 9};
	dll_node<int> *head1 = create_list_from_array(sizeof(foo)/sizeof(foo[0]), foo);
	dll_node<int> *head2 = create_list_from_array(sizeof(foo)/sizeof(foo[0]), foo);
