...
int main() {
    ...
    cout << "----------------------------------------------------" << endl;
    int foo[] = {1, 2, 3, 4, 5};
    LLNode<int> *head = create_list_from_array(sizeof(foo) / sizeof(foo[0]), foo);
    assert(get_length(head) ==
